...
public interface CommentService {
    ...
    List<CommentDto> getCommentsByAdmin(org.springframework.data.domain.Pageable pageable);

    void deleteByAdmin(Long commentId);

    List<CommentDto> getCommentsByPrivate(Long userId, Long eventId, org.springframework.data.domain.Pageable pageable);
